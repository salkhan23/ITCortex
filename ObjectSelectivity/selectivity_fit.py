...
def get_selectivity_distribution(n=1):
    """
    ...
    Broad Spectrum of Sensitivity was observed. Even though supplementary figure 5 gives a
    scatter plot of selectivity for a population, No curve fitting was observed. From Figure 2 A
